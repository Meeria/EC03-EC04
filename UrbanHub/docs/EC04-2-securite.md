...
| 9 | Permissions IAM de l'operateur (celui qui lance Terraform/Ansible) non definies precisement, identifiants personnels potentiellement larges | Acces / identite | Eleve si ces identifiants sont larges (type administrateur) | Moderee | Eleve | Politique de moindre privilege definie en Terraform (`iam_operator.tf`), non attachee volontairement (voir Configuration securite) |
